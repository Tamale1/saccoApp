...
<!-- Mirrored from Newsacco.org/services.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Oct 2022 11:41:22 GMT -->
...
<head>
    ...
    <link rel="icon" type="image/png" href="assets/img/assets/img/logo-sticky.png">
            ...
            <div class="main-responsive-nav">
                <div class="container">
                    <div class="main-responsive-menu">
                        <div class="logo">
                            <a href="index-2.php">
                                <img src="assets/img/logo-wg.png" class="black-logo" alt="image">
                                <img src="assets/img/logo-wg.png" class="white-logo" alt="image">
                            </a>
                        </div>
                    </div>
                </div>
 ...
 <h2>Why you need to save with New’ SACCO</h2>
                    <p>
                        <ul style="list-style-type: none;">
                            <li>No monthly ledger/service charges</li>
                            
                        </ul>
                    </p>
                    <p><h6>Enjoy a variety of our Saving products below</h6></p>
                </div>
                ...
                <div class="tab services-list-tab">
                    <ul class="tabs-list">
                        ...
                        <li>
                            ...
                            <span>TOTO ACCOUNT</span>
                        </li>
                        <li>
                            <i class="flaticon-loan-2"></i>
                            <span>GROUP/CLUB ACCOUNT</span>
                        </li>
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-6">
                                    <div class="services-tab-content">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean nisl erat, gravida malesuada eleifend at, vehicula quis ante. Praesent aliquam enim nec mattis maximus</p>
                                        <h3>Main features of Current Account</h3>
                                        <p>
                                            <ul class="list">
                        ...
                        <div class="tabs_item">
                            <div class="row align-items-center">
                                <div class="col-lg-6">
                                    ...
                                    <ul class="list">
                                        <h3>Main features of FIXED DEPOSIT Account</h3>
                                       
                                       
                                           <li>Fill in <a href="appln2.php">Membership/Account Opening Form</a> and provide all required details</li>
                                    </ul>
                          ...
                          <div class="tabs_item">
                            <div class="row align-items-center">
                                <div class="col-lg-6">
                                    ...
                                    <ul class="list">
                                        <h3>Main features of JOINT Account</h3>
                          ...
                          <div class="tabs_item">
                            <div class="row align-items-center">
                                <div class="col-lg-6">
                                    <div class="services-tab-content">
                                        <p>TLorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean nisl erat, gravida malesuada eleifend at, vehicula quis ante. Praesent aliquam enim nec mattis maximus</p>
                                         </div>
                                    <ul class="list">
                                        <h3>Main Account</h3>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="single-footer-widget">
                            <div class="logo">
                                <a href="#">
                                    <img src="assets/img/h4-logo.png" alt="image">
                                </a>
                            </div>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean nisl erat, gravida malesuada eleifend at, vehicula quis ante. Praesent aliquam enim nec mattis maximus.</p>
                            <ul class="social">
