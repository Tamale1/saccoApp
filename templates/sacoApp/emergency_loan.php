                ...
                <div class="row">
                   ...
                   <div class="col-lg-8 col-md-12">
                        <div class="services-details-desc">
                            ...
                            <div class="content">
                                <h3>About Quick/Emergency loan and how does it work</h3>
                                <p><?php echo $emergency->description;?></p>
                            ...
                            <div class="services-details-features">
                                ...
                                <div class="row">
                                      ...
                                      <ul class="list" style=" list-style-type: none !important;">
                                        ...
                                        <li>
                                            <i class="flaticon-check"></i>
                                        Quick loan processing i.e. 12 hours of loan processing
                                        </li>
                                        <li>
                                            <i class="flaticon-check"></i>
                                        ...
                                        <li>
                                            <i class="flaticon-check"></i>
                                          Maximum loan amount of Ugx 20 million
                                        </li>
                                        <li>
                                            <i class="flaticon-check"></i>
                                        ...
                                        <li>
                                         ...
                                         <li>
                                            <i class="flaticon-check"></i>
                                         Maximum of 2 months’ repayment period.
                                        </li>
