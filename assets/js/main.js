jQuery(function ($) {
	...
	// Buy Now Btn
    $('body').append("<a href='gallery.php' class='buy-now-btn' target='_blank'>Events</a>");
  $('body').append("<a href='loan_application.php' class='loan-now-btn' target='_blank'>Need a Loan?</a>");
